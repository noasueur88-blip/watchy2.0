const TITLES = {stats:'Statistiques',servers:'Serveurs',commands:'Commandes',members:'Membres',moderation:'Moderation',bans:'Bans',scores:'Scores toxicite',badwords:'Mots bannis',config:'Configuration'};
